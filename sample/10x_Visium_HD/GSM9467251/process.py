#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9467251_processed.h5.

For this single sample
(GSM9467251, type-2 diabetes, pre-SGLT2i / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9467251_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9467251_processed.qc.json``.

Provenance:
  gsm        : GSM9467251
  study      : DKD-HIF-SGLT2i (GSE317226)
  condition  : type-2 diabetes, pre-SGLT2i / —
  species    : Homo sapiens
  modality   : spatial (10x Visium HD)
  raw files  : GSM9467251_patient7_aligned_fiducials.jpg.gz; GSM9467251_patient7_aligned_tissue_image.jpg.gz; GSM9467251_patient7_barcodes.tsv.gz; GSM9467251_patient7_cloupe_008um.cloupe.gz; GSM9467251_patient7_cytassist_image.tiff.gz; GSM9467251_patient7_detected_tissue_image.jpg.gz; GSM9467251_patient7_features.tsv.gz; GSM9467251_patient7_matrix.mtx.gz; GSM9467251_patient7_microscope_image.tiff.gz; GSM9467251_patient7_scalefactors_json.json.gz; GSM9467251_patient7_tissue_hires_image.png.gz; GSM9467251_patient7_tissue_lowres_image.png.gz; GSM9467251_patient7_tissue_positions.parquet.gz
...
SAMPLE_META: Dict[str, str] = {
    ...
    'species': 'Homo sapiens',
    'gse': 'GSE317226',
    'study': 'DKD-HIF-SGLT2i',
    'modality': 'spatial',
    'platform': '10x Visium HD',
    'disease_condition': 'DKD (T2D)',
    'tissue_region': 'whole kidney',
    'sex': 'NA',
    'age': 'NA',
    'treatment': 'pre-SGLT2i',
    'model_genotype': 'NA',
    'patient_individual': 'NA',
    'panel_probes': 'WTS (Visium HD)',
    'prep': 'FFPE',
    'reference_genome': 'hg38',
    'condition_detail': 'type-2 diabetes, pre-SGLT2i',
    'timepoint': '—',
}
