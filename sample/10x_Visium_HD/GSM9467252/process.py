#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9467252_processed.h5.

For this single sample
(GSM9467252, type-2 diabetes, pre-SGLT2i / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9467252_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9467252_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9467252_patient9_aligned_fiducials.jpg.gz; GSM9467252_patient9_aligned_tissue_image.jpg.gz; GSM9467252_patient9_barcodes.tsv.gz; GSM9467252_patient9_cloupe_008um.cloupe.gz; GSM9467252_patient9_cytassist_image.tiff.gz; GSM9467252_patient9_detected_tissue_image.jpg.gz; GSM9467252_patient9_features.tsv.gz; GSM9467252_patient9_matrix.mtx.gz; GSM9467252_patient9_microscope_image.tiff.gz; GSM9467252_patient9_scalefactors_json.json.gz; GSM9467252_patient9_tissue_hires_image.png.gz; GSM9467252_patient9_tissue_lowres_image.png.gz; GSM9467252_patient9_tissue_positions.parquet.gz
