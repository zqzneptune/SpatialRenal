#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9467250_processed.h5.

For this single sample
(GSM9467250, type-2 diabetes, pre-SGLT2i / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9467250_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9467250_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9467250_patient5_aligned_fiducials.jpg.gz; GSM9467250_patient5_aligned_tissue_image.jpg.gz; GSM9467250_patient5_barcodes.tsv.gz; GSM9467250_patient5_cloupe_008um.cloupe.gz; GSM9467250_patient5_cytassist_image.tiff.gz; GSM9467250_patient5_detected_tissue_image.jpg.gz; GSM9467250_patient5_features.tsv.gz; GSM9467250_patient5_matrix.mtx.gz; GSM9467250_patient5_microscope_image.tiff.gz; GSM9467250_patient5_scalefactors_json.json.gz; GSM9467250_patient5_tissue_hires_image.png.gz; GSM9467250_patient5_tissue_lowres_image.png.gz; GSM9467250_patient5_tissue_positions.parquet.gz
