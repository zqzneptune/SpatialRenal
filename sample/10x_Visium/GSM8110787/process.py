#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM8110787_processed.h5.

For this single sample
(GSM8110787, control, male, C57BL/6J / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM8110787_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM8110787_processed.qc.json``.

Provenance:
  gsm        : GSM8110787
  study      : hyperuricemia-mouse (GSE258959)
  condition  : control, male, C57BL/6J / —
  species    : Mus musculus
  modality   : spatial (10x Visium)
  raw files  : GSM8110787_Sample_JZ23087188-23209_Control4-23209_Control4-barcodes.tsv.gz; GSM8110787_Sample_JZ23087188-23209_Control4-23209_Control4-features.tsv.gz; GSM8110787_Sample_JZ23087188-23209_Control4-23209_Control4-matrix.mtx.gz; GSM8110787_Sample_JZ23087188-23209_Control4-23209_Control4-spatial.tar.gz
...
SAMPLE_META: Dict[str, str] = {
    ...
    'condition_detail': 'control, male, C57BL/6J',
    'timepoint': '—',
}
