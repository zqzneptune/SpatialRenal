#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9108684_processed.h5.

For this single sample
(GSM9108684, kidney cortex, mild AAV / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9108684_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9108684_processed.qc.json``.

Provenance:
  gsm        : GSM9108684
  study      : ANCA-vasculitis (GSE302677)
  condition  : kidney cortex, mild AAV / —
  species    : Homo sapiens
  modality   : spatial (10x Visium)
  raw files  : GSM9108684_aav1_aligned_fiducials.jpg.gz; GSM9108684_aav1_barcodes.tsv.gz; GSM9108684_aav1_detected_tissue_image.jpg.gz; GSM9108684_aav1_features.tsv.gz; GSM9108684_aav1_matrix.mtx.gz; GSM9108684_aav1_scalefactors_json.json.gz; GSM9108684_aav1_tissue_hires_image.png.gz; GSM9108684_aav1_tissue_lowres_image.png.gz; GSM9108684_aav1_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9108684',
    'sample_id': 'aav1 (mild AAV)',
    'species': 'Homo sapiens',
    'gse': 'GSE302677',
    'study': 'ANCA-vasculitis',
    'modality': 'spatial',
    'platform': '10x Visium',
    'disease_condition': 'ANCA-AAV (mild)',
    ...
    'condition_detail': 'kidney cortex, mild AAV',
    'timepoint': '—',
}
