#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247129_processed.h5.

For this single sample
(GSM9247129, UUO 7d, contralateral, roxadustat / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247129_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247129_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9247129_Exp44_7d_SK3747_CL_aligned_fiducials.jpg.gz; GSM9247129_Exp44_7d_SK3747_CL_aligned_tissue_image.jpg.gz; GSM9247129_Exp44_7d_SK3747_CL_barcodes.tsv.gz; GSM9247129_Exp44_7d_SK3747_CL_features.tsv.gz; GSM9247129_Exp44_7d_SK3747_CL_matrix.mtx.gz; GSM9247129_Exp44_7d_SK3747_CL_scalefactors_json.json.gz; GSM9247129_Exp44_7d_SK3747_CL_tissue_hires_image.png.gz; GSM9247129_Exp44_7d_SK3747_CL_tissue_lowres_image.png.gz; GSM9247129_Exp44_7d_SK3747_CL_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247129',
    'sample_id': 'UUO 7d contralat SK3747',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
