#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM8110786_processed.h5.

For this single sample
(GSM8110786, control, male, C57BL/6J / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM8110786_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM8110786_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM8110786_Sample_JZ23087186-23209_Control3-23209_Control3-barcodes.tsv.gz; GSM8110786_Sample_JZ23087186-23209_Control3-23209_Control3-features.tsv.gz; GSM8110786_Sample_JZ23087186-23209_Control3-23209_Control3-matrix.mtx.gz; GSM8110786_Sample_JZ23087186-23209_Control3-23209_Control3-spatial.tar.gz
