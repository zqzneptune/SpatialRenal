#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9231923_processed.h5.

For this single sample
(GSM9231923, diabetic kidney disease; nephrectomy / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9231923_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9231923_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9231923_V42N07-339_XY04_F44_aligned_fiducials.jpg.gz; GSM9231923_V42N07-339_XY04_F44_barcodes.tsv.gz; GSM9231923_V42N07-339_XY04_F44_features.tsv.gz; GSM9231923_V42N07-339_XY04_F44_matrix.mtx.gz; GSM9231923_V42N07-339_XY04_F44_scalefactors_json.json.gz; GSM9231923_V42N07-339_XY04_F44_tissue_hires_image.png.gz; GSM9231923_V42N07-339_XY04_F44_tissue_lowres_image.png.gz; GSM9231923_V42N07-339_XY04_F44_tissue_positions.csv.gz
