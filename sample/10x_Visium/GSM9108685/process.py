#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9108685_processed.h5.

For this single sample
(GSM9108685, kidney cortex, severe AAV / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9108685_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9108685_processed.qc.json``.

Provenance:
  gsm        : GSM9108685
  study      : ANCA-vasculitis (GSE302677)
  condition  : kidney cortex, severe AAV / —
  species    : Homo sapiens
  modality   : spatial (10x Visium)
  raw files  : GSM9108685_aav2_aligned_fiducials.jpg.gz; GSM9108685_aav2_barcodes.tsv.gz; GSM9108685_aav2_detected_tissue_image.jpg.gz; GSM9108685_aav2_features.tsv.gz; GSM9108685_aav2_matrix.mtx.gz; GSM9108685_aav2_scalefactors_json.json.gz; GSM9108685_aav2_tissue_hires_image.png.gz; GSM9108685_aav2_tissue_lowres_image.png.gz; GSM9108685_aav2_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9108685',
    'sample_id': 'aav2 (severe AAV)',
    'species': 'Homo sapiens',
    'gse': 'GSE302677',
    'study': 'ANCA-vasculitis',
    'modality': 'spatial',
    'platform': '10x Visium',
    'disease_condition': 'ANCA-AAV (severe)',
    'tissue_region': 'kidney cortex',
    'sex': 'NA',
    'age': 'pediatric',
    'treatment': 'NA',
    'model_genotype': 'NA',
    ...
    'condition_detail': 'kidney cortex, severe AAV',
    'timepoint': '—',
}
