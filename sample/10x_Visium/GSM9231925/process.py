#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9231925_processed.h5.

For this single sample
(GSM9231925, diabetic kidney disease; nephrectomy / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9231925_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9231925_processed.qc.json``.

Provenance:
  gsm        : GSM9231925
  study      : DKD-MEF2C (GSE307817)
  condition  : diabetic kidney disease; nephrectomy / —
  species    : Homo sapiens
  modality   : spatial (10x Visium)
  raw files  : GSM9231925_V10S15-103_XY04_IU-21-020F_aligned_fiducials.jpg.gz; GSM9231925_V10S15-103_XY04_IU-21-020F_barcodes.tsv.gz; GSM9231925_V10S15-103_XY04_IU-21-020F_features.tsv.gz; GSM9231925_V10S15-103_XY04_IU-21-020F_matrix.mtx.gz; GSM9231925_V10S15-103_XY04_IU-21-020F_scalefactors_json.json.gz; GSM9231925_V10S15-103_XY04_IU-21-020F_tissue_hires_image.png.gz; GSM9231925_V10S15-103_XY04_IU-21-020F_tissue_lowres_image.png.gz; GSM9231925_V10S15-103_XY04_IU-21-020F_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9231925',
    'sample_id': 'V10S15-103_XY04_IU-21-020F',
    'species': 'Homo sapiens',
    'gse': 'GSE307817',
    'study': 'DKD-MEF2C',
    'modality': 'spatial',
    'platform': '10x Visium',
    'disease_condition': 'DKD',
    ...
    'condition_detail': 'diabetic kidney disease; nephrectomy',
    'timepoint': '—',
}
