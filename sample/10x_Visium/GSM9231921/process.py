#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9231921_processed.h5.

For this single sample
(GSM9231921, diabetic kidney disease; biopsy / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9231921_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9231921_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9231921_V42N07-395_XY01_IU98_aligned_fiducials.jpg.gz; GSM9231921_V42N07-395_XY01_IU98_barcodes.tsv.gz; GSM9231921_V42N07-395_XY01_IU98_features.tsv.gz; GSM9231921_V42N07-395_XY01_IU98_matrix.mtx.gz; GSM9231921_V42N07-395_XY01_IU98_scalefactors_json.json.gz; GSM9231921_V42N07-395_XY01_IU98_tissue_hires_image.png.gz; GSM9231921_V42N07-395_XY01_IU98_tissue_lowres_image.png.gz; GSM9231921_V42N07-395_XY01_IU98_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9231921',
    'sample_id': 'V42N07-395_XY01_IU98',
    'species': 'Homo sapiens',
    'gse': 'GSE307817',
    'study': 'DKD-MEF2C',
    'modality': 'spatial',
