#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9231928_processed.h5.

For this single sample
(GSM9231928, diabetic kidney disease; nephrectomy / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9231928_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9231928_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9231928_V42N07-399_XY04_3775_aligned_fiducials.jpg.gz; GSM9231928_V42N07-399_XY04_3775_barcodes.tsv.gz; GSM9231928_V42N07-399_XY04_3775_features.tsv.gz; GSM9231928_V42N07-399_XY04_3775_matrix.mtx.gz; GSM9231928_V42N07-399_XY04_3775_scalefactors_json.json.gz; GSM9231928_V42N07-399_XY04_3775_tissue_hires_image.png.gz; GSM9231928_V42N07-399_XY04_3775_tissue_lowres_image.png.gz; GSM9231928_V42N07-399_XY04_3775_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9231928',
    'sample_id': 'V42N07-399_XY04_3775',
    'species': 'Homo sapiens',
    'gse': 'GSE307817',
    'study': 'DKD-MEF2C',
    'modality': 'spatial',
