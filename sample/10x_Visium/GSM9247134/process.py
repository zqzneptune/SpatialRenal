#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247134_processed.h5.

For this single sample
(GSM9247134, healthy, hypoxia (0.1% CO) / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247134_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247134_processed.qc.json``.

Provenance:
  gsm        : GSM9247134
  study      : EPO-cell-neighborhood (GSE308511)
  condition  : healthy, hypoxia (0.1% CO) / —
  species    : Mus musculus
  modality   : spatial (10x Visium)
  raw files  : GSM9247134_Exp45_SO4157_aligned_fiducials.jpg.gz; GSM9247134_Exp45_SO4157_aligned_tissue_image.jpg.gz; GSM9247134_Exp45_SO4157_barcodes.tsv.gz; GSM9247134_Exp45_SO4157_features.tsv.gz; GSM9247134_Exp45_SO4157_matrix.mtx.gz; GSM9247134_Exp45_SO4157_scalefactors_json.json.gz; GSM9247134_Exp45_SO4157_tissue_hires_image.png.gz; GSM9247134_Exp45_SO4157_tissue_lowres_image.png.gz; GSM9247134_Exp45_SO4157_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247134',
    'sample_id': 'healthy hypoxia SO4157',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
    ...
    'condition_detail': 'healthy, hypoxia (0.1% CO)',
    'timepoint': '—',
}
