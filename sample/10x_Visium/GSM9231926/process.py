#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9231926_processed.h5.

For this single sample
(GSM9231926, diabetic kidney disease; nephrectomy / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9231926_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9231926_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9231926_V42N07-339_XY01_3781_aligned_fiducials.jpg.gz; GSM9231926_V42N07-339_XY01_3781_barcodes.tsv.gz; GSM9231926_V42N07-339_XY01_3781_features.tsv.gz; GSM9231926_V42N07-339_XY01_3781_matrix.mtx.gz; GSM9231926_V42N07-339_XY01_3781_scalefactors_json.json.gz; GSM9231926_V42N07-339_XY01_3781_tissue_hires_image.png.gz; GSM9231926_V42N07-339_XY01_3781_tissue_lowres_image.png.gz; GSM9231926_V42N07-339_XY01_3781_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9231926',
    'sample_id': 'V42N07-339_XY01_3781',
    'species': 'Homo sapiens',
    'gse': 'GSE307817',
    'study': 'DKD-MEF2C',
    'modality': 'spatial',
