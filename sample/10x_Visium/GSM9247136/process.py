#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247136_processed.h5.

For this single sample
(GSM9247136, healthy, tamoxifen ctrl (normoxia) / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247136_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247136_processed.qc.json``.

Provenance:
  gsm        : GSM9247136
  study      : EPO-cell-neighborhood (GSE308511)
  condition  : healthy, tamoxifen ctrl (normoxia) / —
  species    : Mus musculus
  modality   : spatial (10x Visium)
  raw files  : GSM9247136_tam5x_SM1763_ctrl_aligned_fiducials.jpg.gz; GSM9247136_tam5x_SM1763_ctrl_aligned_tissue_image.jpg.gz; GSM9247136_tam5x_SM1763_ctrl_barcodes.tsv.gz; GSM9247136_tam5x_SM1763_ctrl_features.tsv.gz; GSM9247136_tam5x_SM1763_ctrl_matrix.mtx.gz; GSM9247136_tam5x_SM1763_ctrl_scalefactors_json.json.gz; GSM9247136_tam5x_SM1763_ctrl_tissue_hires_image.png.gz; GSM9247136_tam5x_SM1763_ctrl_tissue_lowres_image.png.gz; GSM9247136_tam5x_SM1763_ctrl_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247136',
    'sample_id': 'healthy normoxia SM1763',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
    ...
    'condition_detail': 'healthy, tamoxifen ctrl (normoxia)',
    'timepoint': '—',
}
