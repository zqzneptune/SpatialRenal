#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM8110785_processed.h5.

For this single sample
(GSM8110785, Uox-KO (hyperuricemia), male, C57BL/6J / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM8110785_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM8110785_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM8110785_Sample_JZ23087189-23209_UoxKO4-23209_UoxKO4-barcodes.tsv.gz; GSM8110785_Sample_JZ23087189-23209_UoxKO4-23209_UoxKO4-features.tsv.gz; GSM8110785_Sample_JZ23087189-23209_UoxKO4-23209_UoxKO4-matrix.mtx.gz; GSM8110785_Sample_JZ23087189-23209_UoxKO4-23209_UoxKO4-spatial.tar.gz
