#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9579055_processed.h5.

For this single sample
(GSM9579055, lupus nephritis, NZB/WF1 F1 female, 30 weeks / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9579055_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9579055_processed.qc.json``.

Provenance:
  gsm        : GSM9579055
  study      : lupus-nephritis-mouse (GSE322686)
  condition  : lupus nephritis, NZB/WF1 F1 female, 30 weeks / —
  species    : Mus musculus
  modality   : spatial (10x Visium)
  raw files  : GSM9579055_s01_A1-well_aligned_fiducials.jpg.gz; GSM9579055_s01_A1-well_barcodes.tsv.gz; GSM9579055_s01_A1-well_detected_tissue_image.jpg.gz; GSM9579055_s01_A1-well_features.tsv.gz; GSM9579055_s01_A1-well_matrix.mtx.gz; GSM9579055_s01_A1-well_scalefactors_json.json.gz; GSM9579055_s01_A1-well_spatial_enrichment.csv.gz; GSM9579055_s01_A1-well_tissue_hires_image.png.gz; GSM9579055_s01_A1-well_tissue_lowres_image.png.gz; GSM9579055_s01_A1-well_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9579055',
    'sample_id': 'NZB/WF1 30w rep1',
    'species': 'Mus musculus',
    'gse': 'GSE322686',
    'study': 'lupus-nephritis-mouse',
    'modality': 'spatial',
    'platform': '10x Visium',
    'disease_condition': 'lupus nephritis',
    'tissue_region': 'whole kidney',
    'sex': 'female',
    'age': '30 weeks',
    'treatment': 'NA',
    'model_genotype': 'NZB/WF1 F1',
    'patient_individual': 'NA',
    'panel_probes': 'WTS (Visium)',
    'prep': 'NA',
    'reference_genome': 'mm10',
    'condition_detail': 'lupus nephritis, NZB/WF1 F1 female, 30 weeks',
    'timepoint': '—',
}
