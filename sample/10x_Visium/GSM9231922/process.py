#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9231922_processed.h5.

For this single sample
(GSM9231922, diabetic kidney disease; biopsy / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9231922_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9231922_processed.qc.json``.

Provenance:
  gsm        : GSM9231922
  study      : DKD-MEF2C (GSE307817)
  condition  : diabetic kidney disease; biopsy / —
  species    : Homo sapiens
  modality   : spatial (10x Visium)
  raw files  : GSM9231922_V42D20-364_XY01_IU103_aligned_fiducials.jpg.gz; GSM9231922_V42D20-364_XY01_IU103_barcodes.tsv.gz; GSM9231922_V42D20-364_XY01_IU103_features.tsv.gz; GSM9231922_V42D20-364_XY01_IU103_matrix.mtx.gz; GSM9231922_V42D20-364_XY01_IU103_scalefactors_json.json.gz; GSM9231922_V42D20-364_XY01_IU103_tissue_hires_image.png.gz; GSM9231922_V42D20-364_XY01_IU103_tissue_lowres_image.png.gz; GSM9231922_V42D20-364_XY01_IU103_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9231922',
    'sample_id': 'V42D20-364_XY01_IU103',
    'species': 'Homo sapiens',
    'gse': 'GSE307817',
    'study': 'DKD-MEF2C',
    'modality': 'spatial',
    ...
    'condition_detail': 'diabetic kidney disease; biopsy',
    'timepoint': '—',
}
