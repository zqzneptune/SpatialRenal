#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9108683_processed.h5.

For this single sample
(GSM9108683, kidney cortex, control / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9108683_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9108683_processed.qc.json``.

Provenance:
  gsm        : GSM9108683
  study      : ANCA-vasculitis (GSE302677)
  condition  : kidney cortex, control / —
  species    : Homo sapiens
  modality   : spatial (10x Visium)
  raw files  : GSM9108683_ctrl_aligned_fiducials.jpg.gz; GSM9108683_ctrl_barcodes.tsv.gz; GSM9108683_ctrl_detected_tissue_image.jpg.gz; GSM9108683_ctrl_features.tsv.gz; GSM9108683_ctrl_matrix.mtx.gz; GSM9108683_ctrl_scalefactors_json.json.gz; GSM9108683_ctrl_tissue_hires_image.png.gz; GSM9108683_ctrl_tissue_lowres_image.png.gz; GSM9108683_ctrl_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    ...
    'condition_detail': 'kidney cortex, control',
    'timepoint': '—',
}
