#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9231920_processed.h5.

For this single sample
(GSM9231920, diabetic kidney disease; biopsy / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9231920_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9231920_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9231920_V42D20-364_XY04_IU92_aligned_fiducials.jpg.gz; GSM9231920_V42D20-364_XY04_IU92_barcodes.tsv.gz; GSM9231920_V42D20-364_XY04_IU92_features.tsv.gz; GSM9231920_V42D20-364_XY04_IU92_matrix.mtx.gz; GSM9231920_V42D20-364_XY04_IU92_scalefactors_json.json.gz; GSM9231920_V42D20-364_XY04_IU92_tissue_hires_image.png.gz; GSM9231920_V42D20-364_XY04_IU92_tissue_lowres_image.png.gz; GSM9231920_V42D20-364_XY04_IU92_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9231920',
    'sample_id': 'V42D20-364_XY04_IU92',
    'species': 'Homo sapiens',
    'gse': 'GSE307817',
    'study': 'DKD-MEF2C',
    'modality': 'spatial',
