#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247130_processed.h5.

For this single sample
(GSM9247130, UUO 7d, contralateral, roxadustat / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247130_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247130_processed.qc.json``.

Provenance:
  gsm        : GSM9247130
  study      : EPO-cell-neighborhood (GSE308511)
  condition  : UUO 7d, contralateral, roxadustat / —
  species    : Mus musculus
  modality   : spatial (10x Visium)
  raw files  : GSM9247130_Exp44_7d_SK3753_CL_aligned_fiducials.jpg.gz; GSM9247130_Exp44_7d_SK3753_CL_aligned_tissue_image.jpg.gz; GSM9247130_Exp44_7d_SK3753_CL_barcodes.tsv.gz; GSM9247130_Exp44_7d_SK3753_CL_features.tsv.gz; GSM9247130_Exp44_7d_SK3753_CL_matrix.mtx.gz; GSM9247130_Exp44_7d_SK3753_CL_scalefactors_json.json.gz; GSM9247130_Exp44_7d_SK3753_CL_tissue_hires_image.png.gz; GSM9247130_Exp44_7d_SK3753_CL_tissue_lowres_image.png.gz; GSM9247130_Exp44_7d_SK3753_CL_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247130',
    'sample_id': 'UUO 7d contralat SK3753',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
    'study': 'EPO-cell-neighborhood',
    'modality': 'spatial',
    'platform': '10x Visium',
    'disease_condition': 'EPO/hypoxia model',
    ...
    'condition_detail': 'UUO 7d, contralateral, roxadustat',
    'timepoint': '—',
}
