#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247132_processed.h5.

For this single sample
(GSM9247132, healthy, roxadustat / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247132_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247132_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9247132_Exp42_SK9682_aligned_fiducials.jpg.gz; GSM9247132_Exp42_SK9682_aligned_tissue_image.jpg.gz; GSM9247132_Exp42_SK9682_barcodes.tsv.gz; GSM9247132_Exp42_SK9682_features.tsv.gz; GSM9247132_Exp42_SK9682_matrix.mtx.gz; GSM9247132_Exp42_SK9682_scalefactors_json.json.gz; GSM9247132_Exp42_SK9682_tissue_hires_image.png.gz; GSM9247132_Exp42_SK9682_tissue_lowres_image.png.gz; GSM9247132_Exp42_SK9682_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247132',
    'sample_id': 'healthy roxadustat SK9682',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
