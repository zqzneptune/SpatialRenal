#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247137_processed.h5.

For this single sample
(GSM9247137, UUO 3d, ligated / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247137_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247137_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9247137_Exp36_3d_SK1441_LIG_aligned_fiducials.jpg.gz; GSM9247137_Exp36_3d_SK1441_LIG_aligned_tissue_image.jpg.gz; GSM9247137_Exp36_3d_SK1441_LIG_barcodes.tsv.gz; GSM9247137_Exp36_3d_SK1441_LIG_features.tsv.gz; GSM9247137_Exp36_3d_SK1441_LIG_matrix.mtx.gz; GSM9247137_Exp36_3d_SK1441_LIG_scalefactors_json.json.gz; GSM9247137_Exp36_3d_SK1441_LIG_tissue_hires_image.png.gz; GSM9247137_Exp36_3d_SK1441_LIG_tissue_lowres_image.png.gz; GSM9247137_Exp36_3d_SK1441_LIG_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247137',
    'sample_id': 'UUO 3d ligated SK1441',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
