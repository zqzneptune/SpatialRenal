#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247127_processed.h5.

For this single sample
(GSM9247127, UUO 7d, ligated, roxadustat / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247127_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247127_processed.qc.json``.

Provenance:
  gsm        : GSM9247127
  study      : EPO-cell-neighborhood (GSE308511)
  condition  : UUO 7d, ligated, roxadustat / —
  species    : Mus musculus
  modality   : spatial (10x Visium)
  raw files  : GSM9247127_Exp44_7d_SK3747_LIG_aligned_fiducials.jpg.gz; GSM9247127_Exp44_7d_SK3747_LIG_aligned_tissue_image.jpg.gz; GSM9247127_Exp44_7d_SK3747_LIG_barcodes.tsv.gz; GSM9247127_Exp44_7d_SK3747_LIG_features.tsv.gz; GSM9247127_Exp44_7d_SK3747_LIG_matrix.mtx.gz; GSM9247127_Exp44_7d_SK3747_LIG_scalefactors_json.json.gz; GSM9247127_Exp44_7d_SK3747_LIG_tissue_hires_image.png.gz; GSM9247127_Exp44_7d_SK3747_LIG_tissue_lowres_image.png.gz; GSM9247127_Exp44_7d_SK3747_LIG_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247127',
    'sample_id': 'UUO 7d ligated SK3747',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
    ...
    'condition_detail': 'UUO 7d, ligated, roxadustat',
    'timepoint': '—',
}
