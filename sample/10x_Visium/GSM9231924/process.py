#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9231924_processed.h5.

For this single sample
(GSM9231924, diabetic kidney disease; nephrectomy / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9231924_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9231924_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9231924_V10S15-103_XY02_IU-21-016F_aligned_fiducials.jpg.gz; GSM9231924_V10S15-103_XY02_IU-21-016F_barcodes.tsv.gz; GSM9231924_V10S15-103_XY02_IU-21-016F_features.tsv.gz; GSM9231924_V10S15-103_XY02_IU-21-016F_matrix.mtx.gz; GSM9231924_V10S15-103_XY02_IU-21-016F_scalefactors_json.json.gz; GSM9231924_V10S15-103_XY02_IU-21-016F_tissue_hires_image.png.gz; GSM9231924_V10S15-103_XY02_IU-21-016F_tissue_lowres_image.png.gz; GSM9231924_V10S15-103_XY02_IU-21-016F_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9231924',
    'sample_id': 'V10S15-103_XY02_IU-21-016F',
    'species': 'Homo sapiens',
    'gse': 'GSE307817',
    'study': 'DKD-MEF2C',
    'modality': 'spatial',
