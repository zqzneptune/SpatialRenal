#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM8110784_processed.h5.

For this single sample
(GSM8110784, Uox-KO (hyperuricemia), male, C57BL/6J / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM8110784_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM8110784_processed.qc.json``.

Provenance:
  gsm        : GSM8110784
  study      : hyperuricemia-mouse (GSE258959)
  condition  : Uox-KO (hyperuricemia), male, C57BL/6J / —
  species    : Mus musculus
  modality   : spatial (10x Visium)
  raw files  : GSM8110784_Sample_JZ23087187-23209_UoxKO3-23209_UoxKO3-barcodes.tsv.gz; GSM8110784_Sample_JZ23087187-23209_UoxKO3-23209_UoxKO3-features.tsv.gz; GSM8110784_Sample_JZ23087187-23209_UoxKO3-23209_UoxKO3-matrix.mtx.gz; GSM8110784_Sample_JZ23087187-23209_UoxKO3-23209_UoxKO3-spatial.tar.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM8110784',
    'sample_id': 'Hyperuricemia mice1',
    'species': 'Mus musculus',
    'gse': 'GSE258959',
    'study': 'hyperuricemia-mouse',
    'modality': 'spatial',
    'platform': '10x Visium',
    'disease_condition': 'hyperuricemia (Uox-KO)',
    'tissue_region': 'whole kidney',
    'sex': 'male',
    'age': 'NA',
    'treatment': 'NA',
    'model_genotype': 'C57BL/6J; Uox-KO',
    'patient_individual': 'NA',
    'panel_probes': 'WTS (Visium)',
    'prep': 'NA',
    'reference_genome': 'mm10',
    'condition_detail': 'Uox-KO (hyperuricemia), male, C57BL/6J',
    'timepoint': '—',
}
