#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247131_processed.h5.

For this single sample
(GSM9247131, healthy, roxadustat / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247131_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247131_processed.qc.json``.

Provenance:
  gsm        : GSM9247131
  study      : EPO-cell-neighborhood (GSE308511)
  condition  : healthy, roxadustat / —
  species    : Mus musculus
  modality   : spatial (10x Visium)
  raw files  : GSM9247131_Exp42_SK7543_aligned_fiducials.jpg.gz; GSM9247131_Exp42_SK7543_aligned_tissue_image.jpg.gz; GSM9247131_Exp42_SK7543_barcodes.tsv.gz; GSM9247131_Exp42_SK7543_features.tsv.gz; GSM9247131_Exp42_SK7543_matrix.mtx.gz; GSM9247131_Exp42_SK7543_scalefactors_json.json.gz; GSM9247131_Exp42_SK7543_tissue_hires_image.png.gz; GSM9247131_Exp42_SK7543_tissue_lowres_image.png.gz; GSM9247131_Exp42_SK7543_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247131',
    'sample_id': 'healthy roxadustat SK7543',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
    ...
    'condition_detail': 'healthy, roxadustat',
    'timepoint': '—',
}
