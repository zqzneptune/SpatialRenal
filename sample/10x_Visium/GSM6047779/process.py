#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM6047779_processed.h5.

For this single sample
(GSM6047779, reference kidney; reused from GSE183456 / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM6047779_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM6047779_processed.qc.json``.

Provenance:
  gsm        : GSM6047779
  study      : kidney-PT-regen (GSE298953)
  condition  : reference kidney; reused from GSE183456 / —
  species    : Homo sapiens
  modality   : spatial (10x Visium)
  raw files  : GSE298953_GSM6047779_V10S15-102_XY02_IU-21-019-5.tar.gz; GSE298953_GSM6047779_V10S15-102_XY02_IU-21-019-5.tif.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM6047779',
    'sample_id': 'V10S15-102_XY02_IU-21-019-5',
    'species': 'Homo sapiens',
    'gse': 'GSE298953',
    ...
    'condition_detail': 'reference kidney; reused from GSE183456',
    'timepoint': '—',
}
