#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247128_processed.h5.

For this single sample
(GSM9247128, UUO 7d, ligated, roxadustat / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247128_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247128_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9247128_Exp44_7d_SK3753_LIG_aligned_fiducials.jpg.gz; GSM9247128_Exp44_7d_SK3753_LIG_aligned_tissue_image.jpg.gz; GSM9247128_Exp44_7d_SK3753_LIG_barcodes.tsv.gz; GSM9247128_Exp44_7d_SK3753_LIG_features.tsv.gz; GSM9247128_Exp44_7d_SK3753_LIG_matrix.mtx.gz; GSM9247128_Exp44_7d_SK3753_LIG_scalefactors_json.json.gz; GSM9247128_Exp44_7d_SK3753_LIG_tissue_hires_image.png.gz; GSM9247128_Exp44_7d_SK3753_LIG_tissue_lowres_image.png.gz; GSM9247128_Exp44_7d_SK3753_LIG_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247128',
    'sample_id': 'UUO 7d ligated SK3753',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
