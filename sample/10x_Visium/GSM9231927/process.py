#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9231927_processed.h5.

For this single sample
(GSM9231927, diabetic kidney disease; nephrectomy / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9231927_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9231927_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9231927_V42N07-399_XY01_3723_aligned_fiducials.jpg.gz; GSM9231927_V42N07-399_XY01_3723_barcodes.tsv.gz; GSM9231927_V42N07-399_XY01_3723_features.tsv.gz; GSM9231927_V42N07-399_XY01_3723_matrix.mtx.gz; GSM9231927_V42N07-399_XY01_3723_scalefactors_json.json.gz; GSM9231927_V42N07-399_XY01_3723_tissue_hires_image.png.gz; GSM9231927_V42N07-399_XY01_3723_tissue_lowres_image.png.gz; GSM9231927_V42N07-399_XY01_3723_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9231927',
    'sample_id': 'V42N07-399_XY01_3723',
    'species': 'Homo sapiens',
    'gse': 'GSE307817',
    'study': 'DKD-MEF2C',
    'modality': 'spatial',
