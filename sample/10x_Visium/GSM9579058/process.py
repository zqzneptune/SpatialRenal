#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9579058_processed.h5.

For this single sample
(GSM9579058, lupus nephritis, NZB/WF1 F1 female, 30 weeks / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9579058_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9579058_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9579058_s04_D1-well_aligned_fiducials.jpg.gz; GSM9579058_s04_D1-well_barcodes.tsv.gz; GSM9579058_s04_D1-well_detected_tissue_image.jpg.gz; GSM9579058_s04_D1-well_features.tsv.gz; GSM9579058_s04_D1-well_matrix.mtx.gz; GSM9579058_s04_D1-well_scalefactors_json.json.gz; GSM9579058_s04_D1-well_spatial_enrichment.csv.gz; GSM9579058_s04_D1-well_tissue_hires_image.png.gz; GSM9579058_s04_D1-well_tissue_lowres_image.png.gz; GSM9579058_s04_D1-well_tissue_positions.csv.gz
