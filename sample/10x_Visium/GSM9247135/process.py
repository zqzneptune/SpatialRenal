#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247135_processed.h5.

For this single sample
(GSM9247135, healthy, tamoxifen ctrl (normoxia) / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247135_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247135_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9247135_tam5x_SM1758_ctrl_aligned_fiducials.jpg.gz; GSM9247135_tam5x_SM1758_ctrl_aligned_tissue_image.jpg.gz; GSM9247135_tam5x_SM1758_ctrl_barcodes.tsv.gz; GSM9247135_tam5x_SM1758_ctrl_features.tsv.gz; GSM9247135_tam5x_SM1758_ctrl_matrix.mtx.gz; GSM9247135_tam5x_SM1758_ctrl_scalefactors_json.json.gz; GSM9247135_tam5x_SM1758_ctrl_tissue_hires_image.png.gz; GSM9247135_tam5x_SM1758_ctrl_tissue_lowres_image.png.gz; GSM9247135_tam5x_SM1758_ctrl_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247135',
    'sample_id': 'healthy normoxia SM1758',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
