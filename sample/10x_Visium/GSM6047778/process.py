#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM6047778_processed.h5.

For this single sample
(GSM6047778, reference kidney; reused from GSE183456 / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM6047778_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM6047778_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSE298953_GSM6047778_V10S15-102_XY03_IU-21-015-2.tar.gz; GSE298953_GSM6047778_V10S15-102_XY03_IU-21-015-2.tif.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM6047778',
    'sample_id': 'V10S15-102_XY03_IU-21-015-2',
    'species': 'Homo sapiens',
    'gse': 'GSE298953',
