#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247133_processed.h5.

For this single sample
(GSM9247133, healthy, hypoxia (0.1% CO) / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247133_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247133_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM9247133_Exp45_SK4156_aligned_fiducials.jpg.gz; GSM9247133_Exp45_SK4156_aligned_tissue_image.jpg.gz; GSM9247133_Exp45_SK4156_barcodes.tsv.gz; GSM9247133_Exp45_SK4156_features.tsv.gz; GSM9247133_Exp45_SK4156_matrix.mtx.gz; GSM9247133_Exp45_SK4156_scalefactors_json.json.gz; GSM9247133_Exp45_SK4156_tissue_hires_image.png.gz; GSM9247133_Exp45_SK4156_tissue_lowres_image.png.gz; GSM9247133_Exp45_SK4156_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247133',
    'sample_id': 'healthy hypoxia SK4156',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
