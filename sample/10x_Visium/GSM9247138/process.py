#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9247138_processed.h5.

For this single sample
(GSM9247138, UUO 3d, ligated / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9247138_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9247138_processed.qc.json``.

Provenance:
  gsm        : GSM9247138
  study      : EPO-cell-neighborhood (GSE308511)
  condition  : UUO 3d, ligated / —
  species    : Mus musculus
  modality   : spatial (10x Visium)
  raw files  : GSM9247138_Exp36_3d_SK1440_LIG_aligned_fiducials.jpg.gz; GSM9247138_Exp36_3d_SK1440_LIG_aligned_tissue_image.jpg.gz; GSM9247138_Exp36_3d_SK1440_LIG_barcodes.tsv.gz; GSM9247138_Exp36_3d_SK1440_LIG_features.tsv.gz; GSM9247138_Exp36_3d_SK1440_LIG_matrix.mtx.gz; GSM9247138_Exp36_3d_SK1440_LIG_scalefactors_json.json.gz; GSM9247138_Exp36_3d_SK1440_LIG_tissue_hires_image.png.gz; GSM9247138_Exp36_3d_SK1440_LIG_tissue_lowres_image.png.gz; GSM9247138_Exp36_3d_SK1440_LIG_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9247138',
    'sample_id': 'UUO 3d ligated SK1440',
    'species': 'Mus musculus',
    'gse': 'GSE308511',
    ...
    'condition_detail': 'UUO 3d, ligated',
    'timepoint': '—',
}
