#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9155022_processed.h5.

For this single sample
(GSM9155022, kidney allograft biopsy; control / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9155022_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9155022_processed.qc.json``.

Provenance:
  gsm        : GSM9155022
  study      : transplant-rejection-FCGR3A (GSE304669)
  condition  : kidney allograft biopsy; control / —
  species    : Homo sapiens
  modality   : spatial (10x Visium CytAssist)
  raw files  : GSM9155022_control_58055_aligned_fiducials.jpg.gz; GSM9155022_control_58055_aligned_tissue_image.jpg.gz; GSM9155022_control_58055_barcodes.tsv.gz; GSM9155022_control_58055_cytassist_image.tiff.gz; GSM9155022_control_58055_detected_tissue_image.jpg.gz; GSM9155022_control_58055_features.tsv.gz; GSM9155022_control_58055_matrix.mtx.gz; GSM9155022_control_58055_scalefactors_json.json.gz; GSM9155022_control_58055_spatial_enrichment.csv.gz; GSM9155022_control_58055_tissue_hires_image.png.gz; GSM9155022_control_58055_tissue_lowres_image.png.gz; GSM9155022_control_58055_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    ...
    'condition_detail': 'kidney allograft biopsy; control',
    'timepoint': '—',
}
