#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM8323124_processed.h5.

For this single sample
(GSM8323124, bIRI / 14 d, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM8323124_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM8323124_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM8323124_visium_day14_male_spaceranger.tar.gz
