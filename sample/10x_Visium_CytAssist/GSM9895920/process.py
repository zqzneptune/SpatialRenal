#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9895920_processed.h5.

For this single sample
(GSM9895920, hypertensive nephropathy, ES / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9895920_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9895920_processed.qc.json``.

Provenance:
  gsm        : GSM9895920
  study      : hypertensive-nephropathy (GSE339455)
  condition  : hypertensive nephropathy, ES / —
  species    : Homo sapiens
  modality   : spatial (10x Visium CytAssist)
  raw files  : GSM9895920_ES_aligned_fiducials.jpg.gz; GSM9895920_ES_aligned_tissue_image.jpg.gz; GSM9895920_ES_barcodes.tsv.gz; GSM9895920_ES_cytassist_image.tiff.gz; GSM9895920_ES_features.tsv.gz; GSM9895920_ES_matrix.mtx.gz; GSM9895920_ES_scalefactors_json.json.gz; GSM9895920_ES_tissue_hires_image.png.gz; GSM9895920_ES_tissue_lowres_image.png.gz; GSM9895920_ES_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9895920',
    'sample_id': 'ES (early stable)',
    'species': 'Homo sapiens',
    'gse': 'GSE339455',
    'study': 'hypertensive-nephropathy',
    'modality': 'spatial',
    'platform': '10x Visium CytAssist',
    'disease_condition': 'hypertensive nephropathy (ES)',
    ...
    'condition_detail': 'hypertensive nephropathy, ES',
    'timepoint': '—',
}
