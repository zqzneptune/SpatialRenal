#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9155025_processed.h5.

For this single sample
(GSM9155025, kidney allograft biopsy; chronic active AMR / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9155025_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9155025_processed.qc.json``.

Provenance:
  gsm        : GSM9155025
  study      : transplant-rejection-FCGR3A (GSE304669)
  condition  : kidney allograft biopsy; chronic active AMR / —
  species    : Homo sapiens
  modality   : spatial (10x Visium CytAssist)
  raw files  : GSM9155025_chronic_active_AMR_58058_aligned_fiducials.jpg.gz; GSM9155025_chronic_active_AMR_58058_aligned_tissue_image.jpg.gz; GSM9155025_chronic_active_AMR_58058_barcodes.tsv.gz; GSM9155025_chronic_active_AMR_58058_cytassist_image.tiff.gz; GSM9155025_chronic_active_AMR_58058_detected_tissue_image.jpg.gz; GSM9155025_chronic_active_AMR_58058_features.tsv.gz; GSM9155025_chronic_active_AMR_58058_matrix.mtx.gz; GSM9155025_chronic_active_AMR_58058_scalefactors_json.json.gz; GSM9155025_chronic_active_AMR_58058_spatial_enrichment.csv.gz; GSM9155025_chronic_active_AMR_58058_tissue_hires_image.png.gz; GSM9155025_chronic_active_AMR_58058_tissue_lowres_image.png.gz; GSM9155025_chronic_active_AMR_58058_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9155025',
    'sample_id': 'chronic active AMR_58058',
    'species': 'Homo sapiens',
    'gse': 'GSE304669',
    'study': 'transplant-rejection-FCGR3A',
    'modality': 'spatial',
    'platform': '10x Visium CytAssist',
    'disease_condition': 'transplant-CAMR (chronic active)',
    ...
    'condition_detail': 'kidney allograft biopsy; chronic active AMR',
    'timepoint': '—',
}
