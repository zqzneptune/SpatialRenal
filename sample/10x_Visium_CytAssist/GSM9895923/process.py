#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM9895923_processed.h5.

For this single sample
(GSM9895923, hypertensive nephropathy, LP / —, Visium spatial transcriptomics (10x Space Ranger)), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM9895923_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM9895923_processed.qc.json``.

Provenance:
  gsm        : GSM9895923
  study      : hypertensive-nephropathy (GSE339455)
  condition  : hypertensive nephropathy, LP / —
  species    : Homo sapiens
  modality   : spatial (10x Visium CytAssist)
  raw files  : GSM9895923_LP_aligned_fiducials.jpg.gz; GSM9895923_LP_aligned_tissue_image.jpg.gz; GSM9895923_LP_barcodes.tsv.gz; GSM9895923_LP_cytassist_image.tiff.gz; GSM9895923_LP_features.tsv.gz; GSM9895923_LP_matrix.mtx.gz; GSM9895923_LP_scalefactors_json.json.gz; GSM9895923_LP_tissue_hires_image.png.gz; GSM9895923_LP_tissue_lowres_image.png.gz; GSM9895923_LP_tissue_positions.csv.gz
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM9895923',
    'sample_id': 'LP (late progressor)',
    'species': 'Homo sapiens',
    'gse': 'GSE339455',
    'study': 'hypertensive-nephropathy',
    'modality': 'spatial',
    'platform': '10x Visium CytAssist',
    'disease_condition': 'hypertensive nephropathy (LP)',
    ...
    'condition_detail': 'hypertensive nephropathy, LP',
    'timepoint': '—',
}
