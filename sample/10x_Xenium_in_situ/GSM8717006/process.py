#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM8717006_processed.h5.

For this single sample
(GSM8717006, normal kidney, 92 weeks, male / 92 weeks, Xenium in situ spatial transcriptomics), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM8717006_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM8717006_processed.qc.json``.

Provenance:
  gsm        : GSM8717006
  study      : kidney-aging-xenium (GSE286051)
  condition  : normal kidney, 92 weeks, male / 92 weeks
  species    : Mus musculus
  modality   : spatial (10x Xenium in situ)
  raw files  : GSM8717006_20210907-NMK92M-Fp1U1.barcodes.tsv.gz; GSM8717006_20210907-NMK92M-Fp1U1.cells.csv.gz; GSM8717006_20210907-NMK92M-Fp1U1.features.tsv.gz; GSM8717006_20210907-NMK92M-Fp1U1.matrix.mtx.gz; GSM8717006_20210907-NMK92M-Fp1U1.morphology.ome.tif.gz; GSM8717006_20210907-NMK92M-Fp1U1.transcripts.parquet.gz; GSM8717006_HE_image_20210907-NMK92M-Fp1U1.ome.tif.gz
...
SAMPLE_META: Dict[str, str] = {
    ...
    'condition_detail': 'normal kidney, 92 weeks, male',
    'timepoint': '92 weeks',
}
