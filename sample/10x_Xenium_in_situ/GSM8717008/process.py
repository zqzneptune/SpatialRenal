#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM8717008_processed.h5.

For this single sample
(GSM8717008, normal kidney, 12 weeks, female / 12 weeks, Xenium in situ spatial transcriptomics), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM8717008_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM8717008_processed.qc.json``.

Provenance:
  gsm        : GSM8717008
  study      : kidney-aging-xenium (GSE286051)
  condition  : normal kidney, 12 weeks, female / 12 weeks
  species    : Mus musculus
  modality   : spatial (10x Xenium in situ)
  raw files  : GSM8717008_0024922_Scan1.qptiff.tiff.gz; GSM8717008_20240208-NMK12F2U1.barcodes.tsv.gz; GSM8717008_20240208-NMK12F2U1.cells.csv.gz; GSM8717008_20240208-NMK12F2U1.features.tsv.gz; GSM8717008_20240208-NMK12F2U1.matrix.mtx.gz; GSM8717008_20240208-NMK12F2U1.morphology.ome.tif.gz; GSM8717008_20240208-NMK12F2U1.transcripts.parquet.gz
...
SAMPLE_META: Dict[str, str] = {
    ...
    'condition_detail': 'normal kidney, 12 weeks, female',
    'timepoint': '12 weeks',
}
