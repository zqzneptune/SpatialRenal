#!/usr/bin/env python
"""Per-sample ingestion + QC: raw/ -> data/GSM8691121_processed.h5.

For this single sample
(GSM8691121, allogeneic, BALB/c→C57BL/6 / —, Xenium in situ spatial transcriptomics), parse the original author-distributed files in
``raw/`` into a standardized, QC-filtered AnnData stored under the unified name
``data/GSM8691121_processed.h5`` (h5ad-compatible HDF5), plus a matching QC report
``data/GSM8691121_processed.qc.json``.
...
Provenance:
  ...
  raw files  : GSM8691121_bc.bl6.1.morphology.ome.tif.gz; GSM8691121_bc.bl6.1.transcripts.zarr.zip
...
SAMPLE_META: Dict[str, str] = {
    'gsm': 'GSM8691121',
    'sample_id': 'BALB/c→B6 allo (Xenium)',
    'species': 'Mus musculus',
    'gse': 'GSE284742',
